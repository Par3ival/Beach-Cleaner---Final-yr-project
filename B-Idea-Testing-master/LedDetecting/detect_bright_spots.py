...
binA = ["red","none","blue","none","green","none","green","none"]
binB = ['red', 'none', 'blue', 'green', 'none', 'red', 'blue', 'none', 'green', 'none', 'red', 'blue', 'none']

binC = ['red', 'none', 'blue', 'green', 'none', 'red' ]
...
def patterncomparer(lightpattern,binpattern):
    for i in range(0,len(lightpattern)):
        if(lightpattern[:len(binpattern)] == binpattern):
            return "True"
        else:
...
def condense(lightpattern):
    ...
    for i in range(0,len(lightpattern),8):
        ...
        #print("red green blue none",col,redcount,greencount,bluecount,nonecount)
...
#@@ Final comparison
stringa = patterncomparer(condense(pattern),binA)
stringb = patterncomparer(condense(pattern),binB) 
stringc = patterncomparer(condense(pattern),binC)

print("is binA?",stringa,"\n is binB?",stringb,"\n is binC?",stringc)
